...
const BlogTitles = () => {
  ...
  const blogCategories = [
    'General' , 'Technology', 'Business', 'Travel', 'Lifestyle','Health','Education', 'Food', 'Sports'
  ]
   ...
   const onSubmitHandler = async (e)=>{
    ...
    try {
        setLoading(true)
        const prompt=`generate catchy blog titles about ${input} in the ${selectedCategory} category.`
