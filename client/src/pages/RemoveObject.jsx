import { Edit, Eraser, Hash, Scissors, Sparkle, Sparkles } from 'lucide-react'
...
const RemoveObject = () => {
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
        ...
        <textarea onChange={(e)=>setObject(e.target.value)}  value={input} rows={4} className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border border-gray-300 ' placeholder='watch or spoon, Only single object name' required/>
           ...
           <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 '>
            ...
            {!content ? (
              ...
              <img src={content} alt='image' className='m-3 w-full h-full'/>
            )}
